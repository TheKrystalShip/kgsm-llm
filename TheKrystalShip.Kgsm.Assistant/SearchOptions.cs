...
public sealed class SearchOptions
{
    ...
    [ConfigField("ragLocalMinScore", "Fall-back-to-web threshold", Group = "rag", Min = 0, Max = 1,
    ...
    [ConfigField("ragMaxContextChars", "Grounding text limit", Group = "rag", Min = 500, Unit = "chars",
        DependsOn = "ragEnabled")]
