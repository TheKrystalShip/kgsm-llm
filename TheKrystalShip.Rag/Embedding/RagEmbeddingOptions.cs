...
public sealed class RagEmbeddingOptions
{
    ...
    [ConfigField("ragEmbeddingProvider", "Embedding server", Group = "rag", Risk = ConfigRisk.Wiring,
    ...
    [ConfigField("ragEmbeddingEndpoint", "Embedding endpoint", Group = "rag", Risk = ConfigRisk.Wiring,
        DependsOn = "ragEnabled")]
    ...
    [ConfigField("ragEmbeddingModel", "Embedding model", Group = "rag", Risk = ConfigRisk.Wiring,
        DependsOn = "ragEnabled")]
    ...
    [ConfigField("ragEmbeddingTimeoutSec", "Embedding timeout", Group = "rag", Min = 1, Unit = "s",
        DependsOn = "ragEnabled")]
    ...
    [ConfigField("ragDocumentPrefix", "Document prefix", Group = "rag", Risk = ConfigRisk.Wiring,
    ...
    /// to match what the index was built with.</panel>
    [ConfigField("ragQueryPrefix", "Query prefix", Group = "rag", Risk = ConfigRisk.Wiring,
        DependsOn = "ragEnabled", NoDefault = true)]
