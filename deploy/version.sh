...
#
# The version is declared in exactly ONE place — TheKrystalShip.Kgsm.Assistant.Service — and read from there, so the package,
# the binary and the changelog can never disagree about what this is.
#
# The SERVICE's version, which is this repo's release line and what CHANGELOG.md tracks. The three
# published libraries (Llm, Kgsm.Assistant, Kgsm.Assistant.Relay) version independently of it.
...
SOURCE_FILE="${HERE}/../TheKrystalShip.Kgsm.Assistant.Service/TheKrystalShip.Kgsm.Assistant.Service.csproj"
